%define		pkgname	strict
Summary:	Strict versions of some standard Haskell data types
Name:		ghc-%{pkgname}
Version:	0.3.2
Release:	1
License:	BSD3
...
# Source0-md5:	35442576f7bd5b12b961c64144c6cb2d
...
data types (pairs, Maybe and Either). It also contains strict
IO operations.
...
%dir %{_libdir}/%{ghcdir}/%{pkgname}-%{version}/Data/Strict
%{_libdir}/%{ghcdir}/%{pkgname}-%{version}/Data/Strict/*.hi
...
%{_libdir}/%{ghcdir}/%{pkgname}-%{version}/Data/Strict/*.p_hi
